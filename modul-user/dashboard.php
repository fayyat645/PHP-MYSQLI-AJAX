            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegister"><i class="fa fa-user-plus" aria-hidden="true"></i>tambah data</button>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                while ($r = mysqli_fetch_object($d)) {
                                    ...
                                    echo '<td><a href="#" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal' . $r->id_user . '"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>';
                                    echo '<td><form action="" method="post"><input name="id_user" type="hidden" value=' . $r->id_user . '><button type="submit" class="btn btn-danger"><i class="fa fa-eraser" aria-hidden="true"></i></form></td>';
                                    echo '<td></td></tr>';
